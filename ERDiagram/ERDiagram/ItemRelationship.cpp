...
ItemRelationship::ItemRelationship( int erModelID, int sx, int sy, QString relationshipText ) : ItemNode( erModelID, sx, sy, PARAMETER_RELATIONSHIP, relationshipText )
{
